...
//    RedisTemplate redisTemplate;
        ...
        public long getExpire(String key) {
            if (StringUtils.isBlank(key)) {
                throw new RuntimeException("key不能blank");
            } else {
         ...
         */
        @SuppressWarnings("unchecked")
        public boolean delFuzzy(String key) {
            Set<String> strings = StringRedisTemplate.keys(key);
        ...
        public String getString(String key) {
            return key == null ? null : redisTemplateString.opsForValue().get(key);
        }
        ...
        public boolean set(String key, String value, long time) {
            try {
                if (time > 0) {
                    redisTemplateString.opsForValue().set(key, value, time, TimeUnit.SECONDS);
                } else {
                    set(key, value);
                }
                return true;
